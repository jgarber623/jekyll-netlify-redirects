...
jekyll-netlify-redirects is written in [Ruby](https://www.ruby-lang.org) (version 2.4.4) and development dependencies are managed using the [Bundler](https://bundler.io) gem.
